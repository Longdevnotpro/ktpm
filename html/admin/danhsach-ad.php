        ...
        <div class="container">
            <nav class="category">
                ...
                <ul class="category-list">
                    ...
                    <li class="category-item category-item-active"><a href="./danhsach-ad.php" class="category-item-link">DANH SÁCH HIỂN THỊ</a></li>
                </ul>
            </nav>
            ...
            <div class="information">
                <div class="information-content">
                    ...
                    <ul class="content-list">
                        <li class="content-item"><a href="../admin/dskhachhang-ad.html" class="content-item-link">Danh sách khách hàng</a></li>
