            ...
            <div class="wrap-information">
                <table>
                    ...
                    <tr>
                        ...
                        <td><a class="insert-button" href="../mainfuntion/insert-ncc.php?id=<?php echo $row['id'];?>">Sửa </a><a class="delete-button" href="../mainfuntion/delete-ncc-nv.php?id=<?php echo $row['id'];?> ">Xoá</a></td>
