        ...
        <div class="container">
            <nav class="category">
                ...
                <ul class="category-list">
                 ...
                 <li class="category-item category-item-active"><a href="./qldonban-nv.php" class="category-item-link">QUẢN LÍ ĐƠN BÁN HÀNG</a></li>
            ...
            <tr>
                    ...
                    <td> <?php echo $row["id"] ?></td>
                        ...
                        <td><a class="insert-button" href="../mainfuntion/insert-banhang.php?id=<?php echo $row['id'];?> ">Sửa </a><a class="delete-button" href="../mainfuntion/delete-banhang-nv.php?id=<?php echo $row['id'];?> ">Xoá</a></td>
                ...
                <div class="add-button">
                    <a href="../mainfuntion/add-banhang.php" class="add-button-link">Thêm mới</a>
                </div>
