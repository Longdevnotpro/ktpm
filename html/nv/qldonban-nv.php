...
<head>
    ...
    <title>Quản lí đơn bán hàng</title>
        ...
        <div class="container">
            <nav class="category">
                ...
                <ul class="category-list">
                 ...
                 <li class="category-item category-item-active"><a href="./qldonban-nv.html" class="category-item-link">QUẢN LÍ ĐƠN BÁN HÀNG</a></li>
                 ...
                 <li class="category-item"><a href="./danhsach-nv.html" class="category-item-link">DANH SÁCH HIỂN THỊ</a></li>
                </ul>
            </nav>
            ...
            <div class="wrap-information">
                <div class="accessories">
                    <span class="accessories-tittle">QUẢN LÍ ĐƠN BÁN HÀNG</span>
                </div>
                <span class="information-accessories">Thông tin hoá đơn</span>
                <div class="accessories-box">
                    ...
                    <div class="accessories-col1">
                        <ul class="col1-list">
                            ...
                            <li class="col1-item">
                                <div class="accessories-code">
                                    <span class="code-label">Ngày bán hàng:</span>
                                    <input type="text" class="col1-item-input">
                                </div>
                            </li>
                    ...
                    <div class="accessories-col1">
                        <ul class="col1-list">
                            <li class="col1-item">
                                <div class="accessories-code">
                                    <span class="code-label">Tên hàng hoá:</span>
                                    <input type="text" class="col1-item-input">
                                </div>
                            </li>
                            <li class="col1-item">
