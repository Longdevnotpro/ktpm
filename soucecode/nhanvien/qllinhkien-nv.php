        ...
        <div class="container">
            <nav class="category">
                ...
                <ul class="category-list">
                 ...
                 <li class="category-item category-item-active"><a href="./qllinhkien-nv.php" class="category-item-link">QUẢN LÍ LINK KIỆN</a></li>
            ...
            <table>
                    ...
                    <tr>
                        ...
                        <td><?php echo $row["malk"] ?></td>
                        <td><?php echo $row["tenlk"] ?></td>
                        <td><?php echo $row["ngaynhap"] ?></td>
                        <td><?php echo $row["loailk"] ?></td>
                        <td><?php echo $row["soluong"] ?></td>
                        <td><?php echo $row["dongia"] ?></td>
                        <td><a class="insert-button" href="../mainfuntion/insert-lk.php?id=<?php echo $row['id'];?> ">Sửa </a><a class="delete-button" href="../mainfuntion/delete-lk-nv.php?id=<?php echo $row['id'];?> ">Xoá</a></td>
                ...
                <div class="add-button">
                    <a href="../mainfuntion/add-lk.php" class="add-button-link">Thêm mới</a>
                </div>
