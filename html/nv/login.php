...
<body>
    <div class="wrapper">
    <form action="validate.php" class="form-login" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-input" name="Mch" placeholder="Nhập mã cửa hàng của bạn">
        </div>
        <div class="form-group">
            <i class="fa-solid fa-users-between-lines"></i>
            <input type="text" class="form-input" name="Mnv" placeholder="Nhập mã nhân viên/admin của bạn">
        </div>
