        ...
        <div class="container">
            <nav class="category">
                ...
                <ul class="category-list">
                 ...
                 <li class="category-item category-item-active"><a href="./quanlidonnhap-nv.php" class="category-item-link">QUẢN LÍ ĐƠN NHẬP HÀNG</a></li>
            ...
            <table>
                    ...
                    <td> <?php echo $row["id"] ?></td>
                        ...
                        <td><a class="insert-button" href="../mainfuntion/insert-nhaphang.php?id=<?php echo $row['id'];?> ">Sửa </a><a class="delete-button" href="../mainfuntion/delete-nhaphang-nv.php?id=<?php echo $row['id'];?> ">Xoá</a></td>
