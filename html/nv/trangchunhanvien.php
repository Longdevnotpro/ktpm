        ...
        <div class="container">
            <nav class="category">
                ...
                <ul class="category-list">
                 <li class="category-item category-item-active"><a href="./trangchunhanvien.php" class="category-item-link">TRANG CHỦ</a></li>
            ...
            <div class="information">
                ...
                <div class="content-header-3">
                    <div class="content-header-4">
                        <span class="outstanding-guest">Khách hàng nổi bật:</span>
