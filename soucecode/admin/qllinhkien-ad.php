        ...
        <div class="container">
            ...
            <table>
                    ...
                    <tr>
                        ...
                        <td><a class="insert-button" href="../mainfuntion/insert-lk.php?id=<?php echo $row['id'];?> ">Sửa </a><a class="delete-button" href="../mainfuntion/delete-lk-ad.php?id=<?php echo $row['id'];?> ">Xoá</a></td>
