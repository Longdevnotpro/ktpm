        ...
        <div class="container">
            ...
            <table>
                    ...
                    <tr>
                        ...
                        <td><a class="insert-button" href="../mainfuntion/insert-nv.php?id=<?php echo $row['id'];?>">Sửa </a><a class="delete-button" href="../mainfuntion/delete-nv.php?id=<?php echo $row['id'];?> ">Xoá</a></td>
                ...
                <div class="add-button">
                    <a href="../mainfuntion/add-nv.php" class="add-button-link">Thêm mới</a>
                </div>
