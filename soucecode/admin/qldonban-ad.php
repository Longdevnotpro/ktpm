        ...
        <div class="container">
            <nav class="category">
                ...
                <ul class="category-list">
                    ...
                    <li class="category-item category-item-active"><a href="./qldonban-ad.php" class="category-item-link">QUẢN LÍ ĐƠN BÁN HÀNG</a></li>
            ...
            <tr>
                    ...
                    <td> <?php echo $row["id"] ?></td>
                        ...
                        <td><a class="insert-button" href="../mainfuntion/insert-banhang.php?id=<?php echo $row['id'];?> ">Sửa </a><a class="delete-button" href="../mainfuntion/delete-banhang-ad.php?id=<?php echo $row['id'];?> ">Xoá</a></td>
