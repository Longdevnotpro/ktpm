        ...
        <div class="container">
            <nav class="category">
                ...
                <ul class="category-list">
                    ...
                    <li class="category-item category-item-active "><a href="./quanlincc-ad.php" class="category-item-link">QUẢN LÍ NHÀ CUNG CẤP</a></li>
            ...
            <table>
                    ...
                    <tr>
                        ...
                        <td><?php echo $row["ngaycc"] ?></td>
                        <td><?php echo $row["email"] ?></td>
                        <td><?php echo $row["thoigianhopdong"] ?></td>
                        <td><a class="insert-button" href="../mainfuntion/insert-ncc.php?id=<?php echo $row['id'];?>">Sửa </a><a class="delete-button" href="../mainfuntion/delete-ncc-ad.php?id=<?php echo $row['id'];?> ">Xoá</a></td>
                ...
                <div class="add-button">
                    <a href="../mainfuntion/add-ncc.php" class="add-button-link">Thêm mới</a>
                </div>
